 ...
 * Game page
 */
public class QuickStartRuntime1Activity extends BaseActivity {

    private String gameId;
    private String gameUrl;
    private String gamePkgVersion;
    private GameRoomTopView topView;
    private final QuickStartRuntime1GameViewModel gameViewModel = new QuickStartRuntime1GameViewModel();
    ...
    public static void start(Context context, GameModel model) {
        Intent intent = new Intent(context, QuickStartRuntime1Activity.class);
    ...
    protected void setListeners() {
        ...
        gameViewModel.progressLiveData.observe(this, new Observer<BaseRuntime1GameViewModel.ProgressModel>() {
            @Override
            public void onChanged(BaseRuntime1GameViewModel.ProgressModel model) {
    ...
    private void updateProgress(BaseRuntime1GameViewModel.ProgressModel model) {
        if (model == null) {
            return;
        }
        if (model.stage == 3) {
