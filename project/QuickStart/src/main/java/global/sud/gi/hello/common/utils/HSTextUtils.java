...
import global.sud.base.utils.Utils;
...
public class HSTextUtils {
     ...
     * 从map当中获取当前语言显示的文本
     */
    public static String getLanguageText(Map<String, String> map) {
        if (map != null) {
            String value = map.get(SystemUtils.getLanguageCode(Utils.getApp()));
